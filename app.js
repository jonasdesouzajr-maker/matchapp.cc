console.log("Mastercode 63.0: Embed-Safe Trailers & Analytics Sync Active");
...
/* 🎬 MASTER CATALOG WITH EMBED-SAFE YOUTUBE IDs */
const masterCatalog = [
    ...
    { title: "Singin' in the Rain", category: "movie", platform: "Max", mood: "laugh", aesthetic: "colorful", pacing: "fast", trailerId: "5_kVUhbIkeI", url: "https://play.max.com/movie/singin-in-the-rain", synopsis: "A silent film star falls for a chorus girl just as he and his delusionally jealous screen partner are trying to make the difficult transition to talking pictures.", poster: "https://images.unsplash.com/photo-1514525253161-7a46d19cd819?auto=format&fit=crop&w=1000&q=80" },
    { title: "2001: A Space Odyssey", category: "movie", platform: "Max", mood: "chill", aesthetic: "epic", pacing: "slow", trailerId: "oR_e9y-bka0", url: "https://play.max.com/movie/2001-a-space-odyssey", synopsis: "After discovering a mysterious artifact buried beneath the Lunar surface, mankind sets off on a quest to find its origins with help from intelligent supercomputer HAL 9000.", poster: "https://images.unsplash.com/photo-1451187580459-43490279c0fa?auto=format&fit=crop&w=1000&q=80" },
    ...
    { title: "The Lord of the Rings: Fellowship", category: "movie", platform: "Max", mood: "intense", aesthetic: "epic", pacing: "steady", trailerId: "V75dSyX1zZk", url: "https://play.max.com/movie/the-lord-of-the-rings-the-fellowship-of-the-ring", synopsis: "A meek Hobbit from the Shire and eight companions set out on a journey to destroy the powerful One Ring and save Middle-earth from the Dark Lord Sauron.", poster: "https://images.unsplash.com/photo-1451187580459-43490279c0fa?auto=format&fit=crop&w=1000&q=80" },
    { title: "Spirited Away", category: "movie", platform: "Max", mood: "chill", aesthetic: "colorful", pacing: "steady", trailerId: "ByXuk9QqQkk", url: "https://play.max.com/movie/spirited-away", synopsis: "During her family's move to the suburbs, a sullen 10-year-old girl wanders into a world ruled by gods, witches, and spirits.", poster: "https://images.unsplash.com/photo-1511671782779-c97d3d27a1d4?auto=format&fit=crop&w=1000&q=80" },
    ...
    { title: "Mad Max: Fury Road", category: "movie", platform: "Max", mood: "intense", aesthetic: "epic", pacing: "fast", trailerId: "hEJnMQG9ev8", url: "https://play.max.com/movie/mad-max-fury-road", synopsis: "In a post-apocalyptic wasteland, a woman rebels against a tyrannical ruler in search for her homeland with the aid of a group of female prisoners.", poster: "https://images.unsplash.com/photo-1509198397868-475647b2a1e5?auto=format&fit=crop&w=1000&q=80" },
    { title: "Fleabag", category: "series", platform: "Prime", mood: "laugh", aesthetic: "modern", pacing: "fast", trailerId: "aX2ViKQFLbc", url: "https://www.primevideo.com/detail/Fleabag/", synopsis: "A comedy series adapted from the award-winning play about a young woman trying to cope with life in London while coming to terms with a recent tragedy.", poster: "https://images.unsplash.com/photo-1517457373958-b7bdd4587205?auto=format&fit=crop&w=1000&q=80" },
    ...
    { title: "The White Lotus", category: "series", platform: "Max", mood: "laugh", aesthetic: "bright", pacing: "slow", trailerId: "TGLq7_MonZ4", url: "https://play.max.com/show/the-white-lotus", synopsis: "Set in a tropical resort, it follows the exploits of various guests and employees over the span of a highly dramatic week.", poster: "https://images.unsplash.com/photo-1518709268805-4e9042af9f23?auto=format&fit=crop&w=1000&q=80" },
    { title: "Arcane", category: "series", platform: "Netflix", mood: "intense", aesthetic: "colorful", pacing: "fast", trailerId: "fXmAurh012s", url: "https://www.netflix.com/title/81435684", synopsis: "Set in utopian Piltover and the oppressed underground of Zaun, the story follows the origins of two iconic League champions-and the power that will tear them apart.", poster: "https://images.unsplash.com/photo-1536440136628-849c177e76a1?auto=format&fit=crop&w=1000&q=80" },
    ...
    { title: "Barbie", category: "movie", platform: "Max", mood: "laugh", aesthetic: "colorful", pacing: "fast", trailerId: "pBk4NYhWNMM", url: "https://play.max.com/movie/barbie", synopsis: "Barbie suffers a crisis that leads her to question her world and her existence.", poster: "https://images.unsplash.com/photo-1517457373958-b7bdd4587205?auto=format&fit=crop&w=1000&q=80" },
    ...
    { title: "Baby Reindeer", category: "series", platform: "Netflix", mood: "intense", aesthetic: "dark", pacing: "steady", trailerId: "eAFOEcGqQzA", url: "https://www.netflix.com/title/81219887", synopsis: "When a struggling comedian shows one act of kindness to a vulnerable woman, it sparks a suffocating obsession which threatens to wreck both their lives.", poster: "https://images.unsplash.com/photo-1536440136628-849c177e76a1?auto=format&fit=crop&w=1000&q=80" },
    { title: "Beef", category: "series", platform: "Netflix", mood: "laugh", aesthetic: "modern", pacing: "fast", trailerId: "AFPIMHBzJQs", url: "https://www.netflix.com/title/81447461", synopsis: "Two people let a road rage incident burrow into their minds and slowly consume their every thought and action.", poster: "https://images.unsplash.com/photo-1518709268805-4e9042af9f23?auto=format&fit=crop&w=1000&q=80" },
    { title: "Dune: Prophecy", category: "series", platform: "Max", mood: "intense", aesthetic: "epic", pacing: "steady", trailerId: "CZ_P7XjPz80", url: "https://play.max.com/show/dune-prophecy", synopsis: "Set 10,000 years before the ascension of Paul Atreides, it follows the Harkonnen Sisters as they combat forces that threaten the future of humankind.", poster: "https://images.unsplash.com/photo-1509198397868-475647b2a1e5?auto=format&fit=crop&w=1000&q=80" },
    { title: "Bridgerton", category: "series", platform: "Netflix", mood: "romantic", aesthetic: "bright", pacing: "steady", trailerId: "niNmDf4wiZY", url: "https://www.netflix.com/title/80232398", synopsis: "Wealth, lust, and betrayal set against the backdrop of Regency-era England, seen through the eyes of the powerful Bridgerton family.", poster: "https://images.unsplash.com/photo-1517457373958-b7bdd4587205?auto=format&fit=crop&w=1000&q=80" },
    { title: "Superbad", category: "movie", platform: "Netflix", mood: "laugh", aesthetic: "colorful", pacing: "fast", trailerId: "4eaZ_48ZYog", url: "https://www.netflix.com/title/70075482", synopsis: "High school seniors Seth and Evan attempt to buy booze for a wild house party, spiraling into an unforgettable night of hilarious chaos.", poster: "https://images.unsplash.com/photo-1517457373958-b7bdd4587205?auto=format&fit=crop&w=1000&q=80" },
    { title: "Parasite", category: "movie", platform: "Max", mood: "intense", aesthetic: "dark", pacing: "steady", trailerId: "5xH0HfJHsaY", url: "https://play.max.com/movie/parasite", synopsis: "Greed and class discrimination threaten the symbiotic relationship between the wealthy Park family and the destitute Kim clan.", poster: "https://images.unsplash.com/photo-1536440136628-849c177e76a1?auto=format&fit=crop&w=1000&q=80" },
    { title: "The Dark Knight", category: "movie", platform: "Max", mood: "intense", aesthetic: "dark", pacing: "fast", trailerId: "UMgb3hQCb08", url: "https://play.max.com/movie/the-dark-knight", synopsis: "When the Joker wreaks havoc on Gotham, Batman must accept his greatest psychological test of fighting injustice.", poster: "https://images.unsplash.com/photo-1509198397868-475647b2a1e5?auto=format&fit=crop&w=1000&q=80" },
    { title: "Interstellar", category: "movie", platform: "Prime", mood: "intense", aesthetic: "epic", pacing: "slow", trailerId: "2LqzF5WauAw", url: "https://www.primevideo.com/detail/Interstellar/", synopsis: "A team of explorers travel through a wormhole in space in an attempt to ensure humanity's survival.", poster: "https://images.unsplash.com/photo-1451187580459-43490279c0fa?auto=format&fit=crop&w=1000&q=80" },
    { title: "Inception", category: "movie", platform: "Max", mood: "intense", aesthetic: "dark", pacing: "fast", trailerId: "8hP9D6kZseM", url: "https://play.max.com/movie/inception", synopsis: "A thief who steals corporate secrets through dream-sharing technology is given the inverse task of planting an idea.", poster: "https://images.unsplash.com/photo-1518709268805-4e9042af9f23?auto=format&fit=crop&w=1000&q=80" },
